...
'# frequency = THz
'# time = ns
'# frequency range: fmin = 21.413747000000001 fmax = 37.474057250000001
'# created = '[VERSION]2022.0|31.0.1|20210823[/VERSION]


'@ use template: [FIR] FSS, Metamaterial - Full Structure.cfg
...
'@ boolean subtract shapes: component1:pillar, component1:tmp

'[VERSION]2022.0|31.0.1|20210823[/VERSION]
Solid.Subtract "component1:pillar", "component1:tmp"
...
With FloquetPort
     .Reset
     .SetDialogFrequency "35.474057250000001" 
     .SetDialogMediaFactor "1.690206766523725" 
     ...
     .Port "Zmax" 
     .SetNumberOfModesConsidered "2" 
     .SetDistanceToReferencePlane "-0.3" 
     .SetUseCircularPolarization "False" 
End With
